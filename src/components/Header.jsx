...
const Header = () => {
    return(
        <>
            <header className="flex md:justify-between bg-[#f6b100] py-4 px-5 items-center">
                <AiOutlineMenu className="md:hidden"/>
                <div className="w-fit self-center md:self-start m-auto md:m-0">
                    <img src={logo} className="img-fluid w-[200px] ml-[50px]"/>
                </div>
                <div className="hidden md:flex gap-10 text-white text-xl mr-[50px]">
                    <AiOutlineSearch/>
